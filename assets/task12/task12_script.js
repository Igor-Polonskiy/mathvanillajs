(() => {
    ...
    const dropZone = document.querySelector('.task12_drop')
    ...
    dropitems.forEach(item => {
        ...
        el.classList.add('task12_dropeitem')
    ...
    document.addEventListener('mouseup', (e) => {
        if (draggingItem) {
            ...
            if (elemBelow.classList.contains("task12_dropeitem") && elemBelow.childNodes.length === 0) {
