(() => {
    ...
    const slots = document.querySelectorAll('.task4_imgWrapper_img')
    ...
    const answers = [{
            id: 1,
            src: './assets3/task4/img/task4_1.png'
        },
        {
            id: 2,
            src: './assets3/task4/img/task4_2.png'
        },
        {
            id: 3,
            src: './assets3/task4/img/task4_3.png'
        },
        {
            id: 4,
            src: './assets3/task4/img/task4_4.png'
        }
    ]
    ...
    document.addEventListener('mouseup', (e) => {
        ...
        if (draggingItem) {
            ...
            if (elemBelow.classList.contains("task4_imgWrapper_img") && elemBelow.childNodes.length === 0) {
