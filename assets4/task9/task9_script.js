(() => {
    ...
    const audiobtn1 = document.querySelector('#task9_audiobtn1')
    const audiobtn2 = document.querySelector('#task9_audiobtn2')
    const audiobtn3 = document.querySelector('#task9_audiobtn3')
    const audiobtn4 = document.querySelector('#task9_audiobtn4')
    ...
    audiobtn4.addEventListener('click', () => {
        audioList[3].play()
    })
