(() => {
    ...
    const dropZone = document.querySelector('.task4_drop')
    const answersWrapper = document.querySelector('.task4_answers')
    const task4 = document.querySelector('.task4_wrapper')
    ...
    const answers = [{
            id: 1,
            data: '1',
            src: './assets4/task4/img/task4_4.png'
        },
        {
            id: 2,
            data: '2',
            src: './assets4/task4/img/task4_2.png'

        },
        {
            id: 3,
            data: '3',
            src: './assets4/task4/img/task4_3.png'

        },
        {
            id: 4,
            data: '4',
            src: './assets4/task4/img/task4_1.png'
    ...
    dropitems.forEach(item => {
        ...
        el.classList.add('task4_dropeitem')
    ...
    task4.addEventListener('mousedown', (e) => {
